/*!
 * dropify-multiple - Override your input files with style. Supports mulitple file uploads
 * @version v1.0.0
 ...
 * @contributors BrewEngage (added support for multi file uploads)
 * @license MIT
 */
...
;(function(root, factory) {
    ...
    DropifyMultiple.prototype.readFile = function(input)
    {
        ...
        // number of files dropped for uploads in the input box
        ...
        {
            var msg = this.totalFiles + " files to uploads.";
            this.filenameWrapper.children('.dropify-filename-inner').html(msg);
        }

        if (j)
        { // if there are files to uploads
