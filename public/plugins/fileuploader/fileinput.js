...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _init: function (options, refreshMode) {
            ...
            self.$progress = $cont.find('.kv-uploads-progress');
            self.$btnUpload = $cont.find('.fileinput-uploads');
                ...
                init: function (id, f, index) {
                    ...
                    if (self.showPreview) {
                        ...
                        if (rm.$thumb && rm.$thumb.length) {
                            ...
                            rm.$btnUpload = rm.$thumb.find('.kv-file-uploads');
        ...
        _initTemplateDefaults: function () {
            var self = this, tMain1, tMain2, tPreview, tFileIcon, tClose, tCaption, tBtnDefault, tBtnLink, tBtnBrowse,
                ...
                tStats;
            tMain1 = '{preview}\n' +
                '<div class="kv-uploads-progress kv-hidden"></div><div class="clearfix"></div>\n' +
                ...
                '    </div>\n' +
                '</div>';
            tMain2 = '{preview}\n<div class="kv-uploads-progress kv-hidden"></div>\n<div class="clearfix"></div>\n' +
                '{remove}\n{cancel}\n{uploads}\n{browse}\n';
            ...
            tProgress = '<div class="progress">\n' +
                ...
                '     </div>\n' +
                '</div>{stats}';
            tStats = '<div class="text-info file-uploads-stats">' +
                '<span class="pending-time">{pendingTime}</span> ' +
                '<span class="uploads-speed">{uploadSpeed}</span>' +
                '</div>';
            ...
            tActions = '<div class="file-actions">\n' +
                ...
                '        {download} {uploads} {delete} {zoom} {other}' +
                '    </div>\n' +
                '</div>\n' +
                '{drag}\n' +
                '<div class="clearfix"></div>';
            ...
            tIndicator = '<div class="file-uploads-indicator" title="{indicatorTitle}">{indicator}</div>';
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    uploadRetryTitle: 'Retry uploads',
        ...
        _listen: function () {
            ...
            self._handler(self.$container.find('.fileinput-uploads'), 'click', $.proxy(self._uploadClick, self));
                ...
                if ($h.isEmpty(data) || $h.isEmpty(data.error)) {
                    ...
                    if (self.showPreview) {
                        $thumbs.each(function () {
                            ...
                            self._setThumbStatus($thumb, 'Success');
                            $thumb.removeClass('file-uploading');
                            $thumb.find('.kv-file-uploads').hide().removeAttr('disabled');
                        });
                    ...
                    if (self.showPreview) {
                        $thumbs.each(function () {
                            var $thumb = $(this);
                            $thumb.removeClass('file-uploading');
                            $thumb.find('.kv-file-uploads').removeAttr('disabled');
        ...
        _initFileActions: function () {
            ...
            self.getFrames(' .kv-file-uploads').each(function () {
                var $el = $(this);
                self._handler($el, 'click', function () {
        ...
        _refreshUploadButton: function ($thumb) {
            var self = this, $btn = $thumb.find('.kv-file-uploads'), cfg = self.fileActionSettings,
        ...
        disable: function () {
            ...
            self.$container.find('.fileinput-remove, .fileinput-uploads, .file-preview-frame button')
                .attr('disabled', true);
    ...
    $.fn.fileinputLocales.en = {
        ...
        pauseLabel: 'Pause',
        pauseTitle: 'Pause ongoing uploads',
        uploadLabel: 'Upload',
        ...
        msgFileRequired: 'You must select a file to uploads.',
        ...
        msgUploadEnd: 'Done',
        msgUploadResume: 'Resuming uploads...',
        msgUploadEmpty: 'No valid data available for uploads.',
        ...
        ajaxOperations: {
            ...
            uploadThumb: 'file uploads',
            uploadBatch: 'batch file uploads',
            uploadExtra: 'form data uploads'
        },
